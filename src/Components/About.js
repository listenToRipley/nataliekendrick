...
const About = () => {
  ...
  return (
    ...
    <Typography> When it comes to problem solving she is proactive, a self-starter. A team playing that believes  her successes benefit the team and vice versa.
</Typography>
    <Typography paragraph>
