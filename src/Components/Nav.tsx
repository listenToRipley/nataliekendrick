...
const Navigation = () => {
    ...
    <nav className="flex items-center justify-between flex-wrap bg-blue-800 p-4">
        ...
        <div className="text-sm lg:flex-grow">
            ...
            <Link to="/resume" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
            Resume
            </Link>

            <Link to="/projects" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
            Projects
            </Link>
